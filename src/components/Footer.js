...
export default function Footer() {
  ...
  const socialLinks = [
    {
      name: 'Twitter',
      href: 'https://twitter.com/scholarsscribe',
      icon: (
    ...
    {
      name: 'LinkedIn',
      href: 'https://linkedin.com/company/scholars-scribe',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Instagram',
      href: 'https://instagram.com/scholarsscribe',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'YouTube',
      href: 'https://youtube.com/@scholarsscribe',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-12">
            ...
            <div className="lg:col-span-1">
              <Link href="/" className="flex items-center space-x-3 mb-6">
                {/* Replaced the div and SVG with the Image component */}
                <Image 
                  src="/logo.svg" // Use the path to your image in the public folder
                  alt="Scholars Scribe Logo"
                  width={48} // Adjusted width based on the original size of the SVG container (12 * 4)
                  height={48} // Adjusted height
                  className="w-12 h-12"
                />
                <div>
                  <h3 className="text-xl font-bold">Scholars Scribe</h3>
                  <p className="text-sm text-gray-400">Academic Excellence Hub</p>
                </div>
              </Link>
              ...
              <div className="mb-6">
                ...
                <div className="flex">
                  ...
                  />
                  <button className="px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 rounded-r-lg font-medium transition-all duration-200">
                    Subscribe
                  </button>
                </div>
              </div>
        ...
        <div className="border-t border-gray-800 py-8">
          <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
            ...
            <div className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-6 text-gray-400 text-sm">
              <p>© 2024 Scholars Scribe. All rights reserved.</p>
          ...
          <div className="mt-6 pt-6 border-t border-gray-800 text-center">
            <p className="text-gray-400 text-sm">
              ...
              <a 
                href="mailto:hello@scholarsscribe.com" 
                className="text-blue-400 hover:text-blue-300 underline"
              >
                hello@scholarsscribe.com
              </a>
            </p>
          </div>
        </div>
