      ...
      <div className="container mx-auto px-6 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/coding-courses" className="text-gray-400 hover:text-white transition-colors">
                  Coding Courses
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/digital-skills" className="text-gray-400 hover:text-white transition-colors">
                  Digital Skills
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center">
          <p className="text-gray-400">
            © 2025 UpSpace. All rights reserved. Built with ❤️ for the next generation of leaders.
          </p>
        </div>
      </div>
    </footer>
