...
export default function Lifestyle() {
  const posts = getAllContent('lifestyle');

  return (
    <div className="container mx-auto px-6 py-12">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-gray-800 mb-4">Lifestyle</h1>
        <p className="text-xl text-gray-600 max-w-2xl mx-auto">
          Explore lifestyle tips, work-life balance strategies, and personal enrichment content.
        </p>
      </div>
