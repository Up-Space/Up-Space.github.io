...
export default function CreativeSkills() {
  const posts = getAllContent('creative-skills');

  return (
    <div className="container mx-auto px-6 py-12">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-gray-800 mb-4">Creative Skills</h1>
        <p className="text-xl text-gray-600 max-w-2xl mx-auto">
          Unleash your creativity with tutorials, tips, and resources for artistic and creative endeavors.
        </p>
      </div>
